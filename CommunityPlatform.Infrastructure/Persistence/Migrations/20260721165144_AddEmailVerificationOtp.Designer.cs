...
namespace CommunityPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260721165144_AddEmailVerificationOtp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.AccountActionToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.District", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.EmployeeProfile", b =>
                {
                    ...
                    b.Property<Guid?>("PreferredDistrictId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.Media", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Checksum")
                        .HasDatabaseName("ix_media_checksum");

                    b.HasIndex("OwnerId")
                        .HasDatabaseName("ix_media_owner");

                    b.ToTable("media", (string)null);
                });

            modelBuilder.Entity("CommunityPlatform.Domain.Entities.MediaVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("media_variant", (string)null);
                });
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.Workshop", b =>
                {
                    ...
                    b.HasIndex("CityId")
                        .HasDatabaseName("ix_workshops_city_id");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.CafeProfile", b =>
                {
                    b.HasOne("CommunityPlatform.Domain.Entities.City", "City")
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CommunityPlatform.Domain.Entities.District", "District")
                        .WithMany()
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.EmployeeProfile", b =>
                {
                    b.HasOne("CommunityPlatform.Domain.Entities.City", "PreferredCity")
                        .WithMany()
                        .HasForeignKey("PreferredCityId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CommunityPlatform.Domain.Entities.District", "PreferredDistrict")
                        .WithMany()
                    ...
                    b.Navigation("PreferredDistrict");
            ...
            modelBuilder.Entity("CommunityPlatform.Domain.Entities.MediaVariant", b =>
                {
                    b.HasOne("CommunityPlatform.Domain.Entities.Media", "Media")
                        .WithMany("Variants")
